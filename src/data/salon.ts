...
export const ritualServices: RitualService[] = [
  ...
  },
  {
    ...
    price: 175,
    bookable: false,
    desc: "Dedicato a chi desidera <strong class=\"font-semibold text-foreground\">ripristinare la funzionalità del cuoio capelluto</strong> estremamente sensibile ed irritato. Un trattamento dolce e delicato che aiuta a ritrovare una piacevole sensazione di benessere grazie agli Oli Essenziali di Mentha Arvensis (risanante), Lavandula Angustifolia (calmante e addolcente) ed Aloe Vera (rigenerante). <strong class=\"font-semibold text-foreground\">Il percorso include:</strong> massaggio distensivo/rilassante Nubeà durante il lavaggio sensoriale con shampoo specifico, lavaggio sensoriale con shampoo specifico, posa in maschera idratante, applicazione fiala post shampoo. Frequenza consigliata: 1 volta alla settimana per almeno 6 settimane. Prezzo per il percorso completo di 6 trattamenti in salone (escluso brushing/piega).",
  },
  {
